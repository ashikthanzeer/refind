...
final class JdbcMappers {
    ...
    static Item item(ResultSet rs) throws SQLException {
        ...
        Item i = "LOST".equals(type) ? new LostItem() : new FoundItem();
    ...
    static Claim claim(ResultSet rs) throws SQLException {
        ...
        Item i = "LOST".equals(itemType) ? new LostItem() : new FoundItem();
        i.setId(rs.getLong("item_id")); c.setItem(i);
    ...
    static Notification notification(ResultSet rs) throws SQLException {
        ...
        n.setText(rs.getString("text")); n.setRead(rs.getBoolean("read_flag"));
